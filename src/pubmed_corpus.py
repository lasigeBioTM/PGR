...
def get_pubmed_ids_list(file_g2p, file_p2g):
    ...
    #for gene_name, phenotype_list in dict_pg.items():  # MESH

        #for phenotype in phenotype_list:
            #os.system('curl "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&term=' + phenotype + '[mesh]+homo+sapiens&retmax=50&retmode=xml" > articles.xml')
...
def main():
    ...
    clean_abstract('corpora/pubmed_corpus/', 'corpora/edited_corpus/')
